...
impl ServerConfig {
    pub fn load() -> Self {
        ...
        Self {
            ...
            handshake_timeout_sec: env::var("ENTROPY_HANDSHAKE_TIMEOUT").unwrap_or_else(|_| "10".to_string()).parse().expect("Invalid timeout"),
    ...
    pub fn test_default() -> Self {
        Self {
            ...
            max_pow_difficulty: 30,
            max_json_depth: 10,
            max_offline_messages: 100,
            max_offline_messages_per_sender: 5,
            pacing: PacingConfig { packet_size: 1024 },
            vdf_modulus: "1234567890".to_string(),
